...
def parse_args():
    ...
    parser.add_argument("--net-output-size", type=int, default=1024, help="Output size of the convolutional network, input size to the LSTM")
    parser.add_argument("--lstm-hidden-size", type=int, default=256, help="Hidden size of the LSTM")
...
class Agent(nn.Module):
    def __init__(self, args, envs):
        ...
        self.actor = fc_layer_init(nn.Linear(lstm_hidden_size, envs.single_action_space.n), std=0.01)
