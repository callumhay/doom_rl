...
class Agent(nn.Module):
  def __init__(self, args, envs):
    ...
    if args.sd_conv:
      ...
      curr_channels, curr_height, curr_width = envs.single_observation_space[0].shape
    ...
    self.game_var_size = envs.single_observation_space[1].shape[0] if len(envs.single_observation_space) > 1 else 0
