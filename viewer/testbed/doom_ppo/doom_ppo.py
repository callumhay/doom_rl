...
def parse_args():
  ...
  parser.add_argument("--automap", type=bool, default=True, help="Whether to use the automap buffer as part of the observations")
  parser.add_argument("--labels", type=bool, default=False, help="Whether to use the labels buffer as part of the observations")
  parser.add_argument("--depth", type=bool, default=False, help="Whether to use the depth buffer as part of the observations")
  

  # Network specific arguments
  parser.add_argument("--z-channels", type=int, default=64, help="Number of z-channels on the last layer of the convolutional network")
  parser.add_argument("--net-output-size", type=int, default=5120, help="Output size of the convolutional network, input size to the LSTM")
  parser.add_argument("--lstm-hidden-size", type=int, default=1280, help="Hidden size of the LSTM")
...
if __name__ == "__main__":
  ...
  for update in range(1, num_updates + 1):
      ...
      if args.anneal_lr:
        ...
        lrnow = max(1e-5, frac * args.learning_rate) #NOTE: had some success with lr around 2.1e-4
